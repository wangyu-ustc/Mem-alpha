...
def main():
    ...
    parser.add_argument('--parquet_path', type=str,
                       default='/mnt/project/wangyu/work/Mem-alpha/data/memalpha/processed_booksum_data.parquet',
    ...
    parser.add_argument('--keyword_mapping_path', type=str,
                       default='/mnt/project/wangyu/work/Mem-alpha/data/booksum_summary_to_keywords_mapping.json',
                       help='Path to keyword mapping file (for replace mode)')
    parser.add_argument('--output_parquet_path', type=str,
                       default='/mnt/project/wangyu/work/Mem-alpha/data/memalpha/processed_booksum_data_with_keywords.parquet',

python /mnt/project/wangyu/work/Mem-alpha/memory_server.py --server_url http://qwen-32b-8node3-clone1.serving.il2-mlp.anuttacon.com/v1 \
  > /mnt/project/wangyu/work/Mem-alpha/outputs/server.out 2>&1 &
...
export WANDB_API_KEY=a4bd420f9a8eb8b97792ab04cfc06382f214dff9
export WANDB_PROJECT="${project_name}"
export WANDB_NAME="${exp_name}"
export BASE_MODEL='/mnt/project/wangyu/models/Qwen3-4B'
export EXPERIMENT_NAME="${exp_name}"

# Data paths
export DATA_DIR='/mnt/project/wangyu/data/memalpha'
...
WORKING_DIR="/mnt/project/wangyu/work/Mem-alpha"
RUNTIME_ENV=${RUNTIME_ENV:-"${WORKING_DIR}/verl/trainer/runtime_env.yaml"}
NNODES=${NNODES:-${PET_NNODES:-4}}

# Model and checkpoint paths
MODEL_PATH=${MODEL_PATH:-"${BASE_MODEL}"}
CKPTS_DIR=${CKPTS_DIR:-"/mnt/project/wangyu/ckpt/${exp_name}"}

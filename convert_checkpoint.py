...
Example:
    python convert_checkpoint.py \
        --checkpoint_path "/mnt/project/wangyu/ckpt/mem-alpha-grpo-memory-agent-qwen3-4b-no-compression-no-thinking-8node/global_step_40" \
        --output_dir "/mnt/project/wangyu/converted_models/mem-alpha-grpo-qwen3-4b-step40-8node" \
        --base_model_path "/mnt/project/wangyu/models/Qwen3-4B"
"""

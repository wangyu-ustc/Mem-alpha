...
# Add transformers for Qwen tokenizer
try:
    from transformers import AutoTokenizer
...
"""
        ...
        # Initialize client based on model type
            ...
            self.client = OpenAI(
                base_url="http://qwen3-32b.serving.il2-mlp.anuttacon.com/v1",
                api_key="EMPTY"
            )
    ...
    def _compute_score(self, data_source, predicted_answer, gold_answer, question=None):
        ...
        if data_source == 'booksum' or data_source == 'infbench_sum_eng_shots2':
            ...
            qwen_client = OpenAI(
                base_url="http://qwen-32b-8node3-clone1.serving.il2-mlp.anuttacon.com/v1",
                api_key="EMPTY"
            )
